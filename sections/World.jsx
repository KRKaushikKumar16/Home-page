  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <TitleText
        title={(
          <>
            Discover a connected universe at AI Nexus, where you can invite them to collaborate in a shared digital space, harnessing the synergy of AI to create, and innovate together.
          </>
        )}
